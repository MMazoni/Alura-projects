        ...
        <table class="table">
            ...
            <tbody>
                <?php foreach ($lista as $linha): ?>
                    <tr>
                        <td><a href="/categorias-detalhe.php?id=<?= $linha['id'] ?>" class="btn btn-link"><?php echo $linha['id'] ?></a></td>
                        <td><a href="/categorias-detalhe.php?id=<?= $linha['id'] ?>" class="btn btn-link"><?php echo $linha['nome'] ?></a></td>
